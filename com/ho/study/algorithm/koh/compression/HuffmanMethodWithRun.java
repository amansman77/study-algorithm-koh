...
public class HuffmanMethodWithRun {
    ...
    private static MinHeap<Run> heap;
    private static Run rootOfHuffmanTree = null;
    ...
    private static void printHuffmanTree() {
        preOrderTraverse(rootOfHuffmanTree, 0);
    }

    private static void preOrderTraverse(Run node, int depth) {
